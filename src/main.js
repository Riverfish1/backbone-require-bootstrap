...
(function () {
	...
	require(['backbone', 'underscore', 'bootstrap', 'bootstrapTableLocal', 'src/router/router-cfg-version', 'src/components/app/appView', 'box'], function(Backbone, _, Bootstrap, BT, config, AppView, Bootbox){
		new AppView();
